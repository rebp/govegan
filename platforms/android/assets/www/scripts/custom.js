$(document).ready(function () {
            ...
            $('.button, .icon, .footer-menu-item i, .footer-menu-controls a, .mobileui-home a i, .landing-homepage ul li a i').on('click', function (event) {
              ...
              $div
                .css({
                  ...
                  background: "rgba(255,255,255,7)" //$(this).data("ripple-color")
                }) 
                .appendTo($(this));
    ...
    function favorites() {
        ...
        var favorite_videos = $("#favorite_videos");
        var favorite_recipes = $("#favorite_recipes");

        favorite_videos.hide();

        $(".show-favorite-videos").on("click", function(e){
            ...
            favorite_videos.show();
            favorite_recipes.hide();


            e.preventDefault();
        });

        $(".show-favorite-recipes").on("click", function(e){
